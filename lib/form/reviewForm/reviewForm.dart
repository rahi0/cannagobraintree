...
class _ReviewFormState extends State<ReviewForm> {
                      ...
                      //  border: Border.all(color: Colors.black38, width: 0.5),
                        ...
                        //     fit: BoxFit.fill),
                         ...
                         image: DecorationImage(
                           ...
                           image:widget.d.item.img==null? AssetImage('assets/img/medicine_icon.PNG'):NetworkImage("https://www.dynamyk.biz"+widget.d.item.img),
                           fit: BoxFit.fill),
                        boxShadow: [
                          BoxShadow(
  ...
  void _submitReview() async {
    if (rating == 0.0) {
      return showMsg("Star rating is no given");
    } else if (reviewController.text.isEmpty) {
      return showMsg("Content is empty");
    }
    ...
    var data = {
      'order_id': widget.d.orderId,
      'itemId': widget.d.itemId,
      'growId': widget.d.item.growId,
      'rating': rating,
      'content': reviewController.text,
      'title': "Review",
      'body': "You have a review for item ${widget.d.itemId}",
      'click_action': 'FLUTTER_NOTIFICATION_CLICK'
    };
 
    print(data);

   var res = await CallApi().postData(data, '/app/itemreviews');
